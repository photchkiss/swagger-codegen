...
public class CSharpNetStandardClientCodeGen extends AbstractCSharpCodegen {
    ...
    private static final String NETSTANDARD = "v6.0";
    ...
    protected String targetFramework = NETSTANDARD;

    // Defines nuget identifiers for target framework
    protected String targetFrameworkNuget = "netstandard2.0";
    protected boolean supportsAsync = Boolean.TRUE;
    protected boolean netStandard = Boolean.TRUE;
    ...
    public CSharpNetStandardClientCodeGen() {
        ...
        frameworks = new ImmutableMap.Builder<String, String>()
                .put(NETSTANDARD, ".NET Standard 2.0 compatible")
                .build();
        ...
        this.netCoreProjectFileFlag = Boolean.TRUE; 
    ...
    public void processOpts() {
        ...
        setTargetFramework(NETSTANDARD);
